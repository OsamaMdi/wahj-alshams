    ...
    public function store(Request $request)
{
    ...
    // تنظيف وحفظ الشخصيات كمصفوفة
    $validated['characters'] = array_values(array_filter($validated['characters'] ?? []));

    Masrahiya::create($validated);

    return redirect()->route('admin.masrahiyat.index')->with('success', 'Play created successfully.');
}
    ...
    public function update(Request $request, Masrahiya $masrahiya)
{
    ...
    return redirect()->route('admin.masrahiyat.index')->with('success', 'Play updated successfully.');
}
    ...
    public function destroy(Masrahiya $masrahiya)
    {
        ...
        $masrahiya->delete();
        return redirect()->route('admin.masrahiyat.index')->with('success', 'Play deleted successfully.');
    }
}
