...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        <form action="{{ route('admin.teamwork.update', $teamwork) }}" method="POST" enctype="multipart/form-data" id="editTeamForm">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <div class="mt-2">
                    <img id="imagePreview" src="{{ asset('storage/' . $teamwork->image_path) }}"
