                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="{{ 0.1 + ($index % 4) * 0.1 }}s">
                    <div class="service-item">
                        <div class="service-inner pb-5">
                            <img class="img-fluid w-100" src="{{ asset('img/' . $service['img']) }}" alt="">
...
<div class="container-fluid team pt-6 pb-6">
    <div class="container">
        ...
        <div class="row g-4">
            @foreach ([
            ['img' => 'team-1.jpg', 'name' => 'Alex Robin'],
            ['img' => 'team-2.jpg', 'name' => 'Andrew Bon'],
            ['img' => 'team-3.jpg', 'name' => 'Martin Tompson'],
            ['img' => 'team-4.jpg', 'name' => 'Clarabelle Samber'],
            ] as $index => $team)
